  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var InvalidInputException = (function (_Error) {
        ...
        function InvalidInputException(symbology, input) {
          ...
          _this.message =
            '"' + _this.input + '" is not a valid input for ' + _this.symbology;
          return _this;
        }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function registerBarcode(barcodes, name) {
        API.prototype[name] = API.prototype[name.toUpperCase()] = API.prototype[
          name.toLowerCase()
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var CODE128A = (function (_CODE) {
        ...
        function CODE128A(string, options) {
          ...
          return _possibleConstructorReturn(
            this,
            (CODE128A.__proto__ || Object.getPrototypeOf(CODE128A)).call(
              this,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var CODE128B = (function (_CODE) {
        ...
        function CODE128B(string, options) {
          ...
          return _possibleConstructorReturn(
            this,
            (CODE128B.__proto__ || Object.getPrototypeOf(CODE128B)).call(
              this,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var CODE128C = (function (_CODE) {
        ...
        function CODE128C(string, options) {
          ...
          return _possibleConstructorReturn(
            this,
            (CODE128C.__proto__ || Object.getPrototypeOf(CODE128C)).call(
              this,
        ...
        function CODE128AUTO(data, options) {
          ...
          if (/^[\x00-\x7F\xC8-\xD3]+$/.test(data)) {
            var _this = _possibleConstructorReturn(
              this,
              (
                CODE128AUTO.__proto__ || Object.getPrototypeOf(CODE128AUTO)
          ...
          },
          {
            ...
            value: function encode() {
              ...
              return {
                ...
                data:
                  "1011" + (0, _encoder2.default)(this.data, structure, "01"),
                text: this.text,
              };
            },
          },
      ...
      var UPCE = (function (_Barcode) {
        ...
        function UPCE(data, options) {
          ...
          if (data.search(/^[0-9]{6}$/) !== -1) {
            ...
            _this.text =
              options.text ||
              "" + _this.upcA[0] + data + _this.upcA[_this.upcA.length - 1];
            _this.isValid = true;
        ...
        _createClass(UPCE, [
          ...
          },
          {
            ...
            value: function encodeMiddleDigits() {
              ...
              var parity =
                PARITIES[parseInt(checkDigit)][parseInt(numberSystem)];
      ...
      var GenericBarcode = (function (_Barcode) {
        ...
        function GenericBarcode(data, options) {
          ...
          return _possibleConstructorReturn(
            this,
            (
              GenericBarcode.__proto__ || Object.getPrototypeOf(GenericBarcode)
            ).call(this, data, options)
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var pharmacode = (function (_Barcode) {
        ...
        function pharmacode(data, options) {
          ...
          var _this = _possibleConstructorReturn(
            this,
            (pharmacode.__proto__ || Object.getPrototypeOf(pharmacode)).call(
              this,
              data,
              options
            )
        ...
        _createClass(CanvasRenderer, [
          ...
          },
          {
            ...
            value: function prepareCanvas() {
              ...
              var maxHeight = (0, _shared.getMaximumHeightOfEncodings)(
                this.encodings
              );
        ...
        _createClass(SVGRenderer, [
          ...
          },
          {
            ...
            value: function setSvgAttributes(width, height) {
              ...
              svg.setAttribute("style", "transform: scale(1.5,1)");
            },
          },
          {
            key: "createGroup",
